...
if ($_SESSION["Role"] == null) {
    header("Location: ../FlexStart/landing.html");
    exit;
} else {
...
if (isset($_POST['addActivity'])) {
    ...
    // if (file_exists("activityImg/" . $_FILES['image']['name'])) {
    //     $filename = $_FILES['image']['name'];
    //     // $_SESSION['imgStatus'] = $fileName . "Image Already Exists!";
...
$result = $con->query($sqlActivity);
$rowActivity = $result->fetch_assoc();
...
// Use the same fetched data for the modal and set sections
$resultModalActivity = $resultSetActivity = $resultActivity;
